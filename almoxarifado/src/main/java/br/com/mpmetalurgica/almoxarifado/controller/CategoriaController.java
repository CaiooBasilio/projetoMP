...
import org.springframework.web.bind.annotation.PutMapping;
    ...
    public class CategoriaController {
        ...
        public ResponseEntity<?> novaCategoria(@RequestBody Categoria newCategoria) {
            ...
            service.adicionaCategoria(newCategoria);
        ...
        @GetMapping("/{nome}")
        public ResponseEntity<Categoria> encontraNome(@PathVariable String nome){
        ...
        @DeleteMapping("/{nome}")
        public ResponseEntity<?> excluiPorNome(@PathVariable String nome){

            //boolean removido = service.listaCategorias().deleteByNome(nome);
// (name -> name.getNomeCategoria().equals(nome))
            if(service.existsByNomeCategoria(nome)){
